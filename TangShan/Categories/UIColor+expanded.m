...
+ (UIColor *)chopeFormLabelTextColor
{
    return [UIColor darkGrayColor];
}


+ (UIColor *)defaultTintColorForIOS7
{
    return [UIColor colorWithHue:41/255.0f saturation:144/255.0f brightness:252/255.0F alpha:1.0f];
}
