...
+(UIColor *)red
{
    return [UIColor colorWithRed:86.0/255.0 green:196.0/255.0 blue:251.0/255.0 alpha:1.0f];
}

+(UIColor *)green
{
    return [UIColor colorWithRed:250.0/255.0 green:255.0/255.0 blue:9.0/255.0 alpha:1.0f];
}
