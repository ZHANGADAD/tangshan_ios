...
- (void)setDefaults {
    ...
    self.opaque=NO;
    self.selectionIndicatorColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.0f];
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, self.frame.size.height, stringWidth, self.selectionIndicatorHeight);
    } else {
...
- (void)setSelectedIndex:(NSUInteger)index animated:(BOOL)animated {
    ...
    if (self.delegate) {
        [self.delegate segementDidSelect:index withSegeMent:self];
    }
